    ...
    <div className="flex min-h-screen items-center justify-center bg-bg px-5">
      <div className="w-full max-w-sm">
        <div className="mb-7 text-center">
          ...
          <h1 className="font-display mt-4 text-xl font-extrabold">Admin Glori Barbershop</h1>
          <p className="mt-1 text-sm text-text-secondary">Masuk untuk mengelola operasional toko</p>
        </div>
